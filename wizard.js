...
// This plugin will progressively create a wizard ui pattern to an element,
// allowing for easy fallback to noscript without actually using noscript markup.
// For example, you would pass a container class such as $('.chunk-container')
// to the plugin and it will find all headers within that container for the list, then apply
// appropriate Bootstrap nav classes to the page, along with previous and next buttons.
// Each page of the wizard should have a div with a "chunk" class (that's an optional name). 
// The plugin will handle pagination from there.
...
//  </section>
//  <script>
//      $('.chunk-container').wizardBuilder({modifierClass: "tabs", nextOption: "default"});
//  </script>
//
//  Known issues:
